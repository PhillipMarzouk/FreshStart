...
INSERT INTO `auth_user` VALUES (1,'pbkdf2_sha256$600000$NJrV4Vom8hYzr0XF0sDeUF$Bu9bPu3BslJ75tkDJX0JikNtHlLczWF9+a5QpHPWpJk=','2025-03-19 21:06:35.529830',1,'admin','Phillip','Marzouk','phillipmarzouk@gmail.com',1,1,'2025-03-14 04:53:44.000000'),(2,'pbkdf2_sha256$600000$ifAGtnpuJbKyzsZ8979JbN$NiSAcwpysYn59oxRKTSusDVCY7Rkl6Zb2xy7XK10dw8=','2025-03-14 18:37:28.000000',0,'SkyHigh','Lunch','Lady','phillip@digitalonbrand.com',0,1,'2025-03-14 18:35:58.000000');
...
INSERT INTO `django_content_type` VALUES (1,'admin','logentry'),(3,'auth','group'),(2,'auth','permission'),(4,'auth','user'),(5,'contenttypes','contenttype'),(14,'food_order_api','cart'),(20,'food_order_api','customersupportprofile'),(21,'food_order_api','customuser'),(17,'food_order_api','deliveryschedule'),(11,'food_order_api','fooditem'),(7,'food_order_api','foodtype'),(8,'food_order_api','lunchprogram'),(9,'food_order_api','menudate'),(12,'food_order_api','menuitem'),(15,'food_order_api','orderitem'),(10,'food_order_api','plateportion'),(18,'food_order_api','userdeliveryschedule'),(19,'food_order_api','userlunchprogram'),(13,'food_order_api','userorder'),(16,'food_order_api','userprofile'),(6,'sessions','session');
...
INSERT INTO `django_session` VALUES ('1z1nnqf4ja4u9s811uwhgq8n5plde22z','.eJxVjDsOgzAQRO_iOrLwD3tTpucMlpddxyQRljBUUe4ekCiScua9mbeIaVtL3BovcSJxFUpcfjtM45PnA9Ajzfcqxzqvy4TyUORJmxwq8et2un8HJbWyry1k9KbXRF0I3iJllRksBMfArk-hC3Z0njFr0i4pvScEMEqjz6CN-HwB4Uk3lQ:1tv0cV:vFPY2xJntnmtwS3PQfEnpXzaiYjGkvEBUggY_gOUzWk','2025-04-02 21:06:35.538520'),('5rk5bv4pb2m53rqeh8ldens0jnrn68lu','.eJxVjDsOgzAQRO_iOrLwD3tTpucMlpddxyQRljBUUe4ekCiScua9mbeIaVtL3BovcSJxFUpcfjtM45PnA9Ajzfcqxzqvy4TyUORJmxwq8et2un8HJbWyry1k9KbXRF0I3iJllRksBMfArk-hC3Z0njFr0i4pvScEMEqjz6CN-HwB4Uk3lQ:1tux2u:Ajwgeab2PoBHfB2nEuPA-CSYslyCw7tJWB8dz_kbAgg','2025-04-02 17:17:36.323457'),('8v67l6cf2ker7onf1cow79tz3bj9jncd','.eJxVjDsOgzAQRO_iOrLwD3tTpucMlpddxyQRljBUUe4ekCiScua9mbeIaVtL3BovcSJxFUpcfjtM45PnA9Ajzfcqxzqvy4TyUORJmxwq8et2un8HJbWyry1k9KbXRF0I3iJllRksBMfArk-hC3Z0njFr0i4pvScEMEqjz6CN-HwB4Uk3lQ:1tub89:Dn4Li0Ku4MqKdde_Kf64rC3Alj1sQLRkadIop9oO1cU','2025-04-01 17:53:33.710600'),('9jhbxxayipn53fdlrxhd6hqt3h7id87f','.eJxVjDsOgzAQRO_iOrLwD3tTpucMlpddxyQRljBUUe4ekCiScua9mbeIaVtL3BovcSJxFUpcfjtM45PnA9Ajzfcqxzqvy4TyUORJmxwq8et2un8HJbWyry1k9KbXRF0I3iJllRksBMfArk-hC3Z0njFr0i4pvScEMEqjz6CN-HwB4Uk3lQ:1tunoY:tq81SjW5AprD6qs24QYfUMOLOqgXtflP1Fg-ZOQG3ck','2025-04-02 07:26:10.018115'),('ki7c27n410xkbw6nyxe4ela9u5live3i','.eJxVjEsOwjAMRO-SNYr6MXHCkn3PENmOoQWUSE27QtydVuoCdqN5b-ZtIq3LGNeqc5ySuZjOnH47Jnlq3kF6UL4XKyUv88R2V-xBqx1K0tf1cP8ORqrjtg7ILVLLPaAyBCfoHSaETlQVgJru7IQRJEi49Z4SN-yk9dB43nJvPl_hmzgH:1tt9uS:iaddijczgJd7dKvvOW8VMCG_wICNcF46S_q7Sr7L1bE','2025-03-28 18:37:28.612390');
...
INSERT INTO `food_order_api_menuitem` VALUES (104,'Chocolate Chip Muffin','Breakfast',0,'2025-03-19','menu_images/bakery-style-chocolate-chip-muffins-1-of-1-500x375.webp'),(105,'Cinnamon Toast Crunch & WG Crackers','Breakfast',1,'2025-03-19','menu_images/image_fx__21.jpg'),(106,'Hamburger w/sweet potato (3/4c)','Hot Meal',0,'2025-03-19','menu_images/image_fx__22.jpg'),(107,'Lemon Garlic Chicken w/cilantro rice (3/4c) & glazed peas & carrots (3/4c)','Hot Meal',0,'2025-03-19','menu_images/image_fx__5.jpg'),(108,'Bean & Cheese Burrito w/carrot sticks (1/2c)','Hot Vegetarian',0,'2025-03-04','menu_images/image_fx__6.jpg'),(109,'Roasted Pepper Chicken Hoagie Sandwich w/carrot sticks (3/4c)','Cold Meal',0,'2025-03-19','menu_images/image_fx__7.jpg'),(110,'Asian Chicken Pasta Salad','Cold Pastas',0,'2025-03-03','menu_images/image_fx__8.jpg'),(111,'Garlic Pesto Cheese Pasta Salad w/carrot sticks (3/4c)','Cold Vegetarian',0,'2025-03-19','menu_images/image_fx__9.jpg'),(112,'Caesar Chicken Salad with a Wheat Dinner Roll','Daily Salad',0,'2025-03-19','menu_images/image_fx__10.jpg'),(113,'Oatmeal Cookie (S)','Snack',0,'2025-03-19','menu_images/oatmeal_cookie.jpg'),(114,'Sausage English Muffin','Breakfast',0,'2025-03-19','menu_images/image_fx__11.jpg'),(115,'Bagel & Jelly','Breakfast',0,'2025-03-04','menu_images/image_fx__12.jpg'),(116,'Sloppy Joe on a HB Bun w/sweet corn medley (3/4c)','Hot Meal',0,'2025-03-19','menu_images/image_fx__13.jpg'),(117,'Fresco Beef w/cilantro rice (3/4c) & sweet corn medley (3/4c)','Hot Meal',0,'2025-03-19','menu_images/image_fx__14.jpg'),(118,'Black Bean Burger w/sweet corn medley (3/4c)','Hot Vegetarian',0,'2025-03-19','menu_images/image_fx__15.jpg'),(119,'Turkey & Cheese Hoagie Sandwich w/garden corn salad (3/4c)','Cold Meal',0,'2025-03-19','menu_images/image_fx__16.jpg'),(120,'Fiesta Chicken Pasta Salad','Cold Pastas',0,'2025-03-19','menu_images/image_fx__17.jpg'),(121,'Bean & Cheese Torta w/garden corn salad (3/4c)','Cold Vegetarian',0,'2025-03-04','menu_images/image_fx__18.jpg'),(122,'Mediterranean Chicken Salad with a Wheat Dinner Roll','Daily Salad',0,'2025-03-19','menu_images/image_fx__19_TDl5XwY.jpg'),(123,'Banana Muffin (S)','Snack',0,'2025-03-05','menu_images/image_fx__20.jpg');
...
INSERT INTO `food_order_api_menuitem_lunch_programs` VALUES (8,104,1),(9,104,2),(10,104,3),(11,104,4),(12,104,5),(13,105,1),(14,105,2),(15,105,3),(16,105,4),(17,105,5),(18,106,1),(19,107,1),(20,108,1),(21,109,1),(22,110,1),(23,110,2),(24,110,3),(25,110,4),(26,110,5),(27,111,1),(28,112,1),(29,112,2),(30,112,3),(31,112,4),(32,112,5),(33,113,1),(34,113,2),(35,113,3),(36,113,4),(37,113,5),(38,114,1),(39,114,2),(40,114,3),(41,114,4),(42,114,5),(43,115,1),(44,115,2),(45,115,3),(46,115,4),(47,115,5),(48,116,1),(49,117,1),(50,118,1),(51,119,1),(52,120,1),(53,120,2),(54,120,3),(55,120,4),(56,120,5),(57,121,1),(58,122,1),(59,122,2),(60,122,3),(61,122,4),(62,122,5),(63,123,1),(64,123,2),(65,123,3),(66,123,4),(67,123,5);
...
INSERT INTO `food_order_api_orderitem` VALUES (22,7,110,100,'2025-03-03'),(23,7,108,270,'2025-03-04'),(24,7,115,570,'2025-03-04'),(25,7,121,450,'2025-03-04'),(26,7,123,2470,'2025-03-05'),(27,7,104,250,'2025-03-19'),(28,7,105,760,'2025-03-19'),(29,7,106,330,'2025-03-19'),(30,7,107,660,'2025-03-19'),(31,7,109,740,'2025-03-19'),(32,7,111,320,'2025-03-19'),(33,7,112,240,'2025-03-19'),(34,7,113,740,'2025-03-19'),(35,7,114,20,'2025-03-19'),(36,7,116,740,'2025-03-19'),(37,7,117,20,'2025-03-19'),(38,7,118,560,'2025-03-19'),(39,7,119,240,'2025-03-19'),(40,7,120,170,'2025-03-19'),(41,7,122,130,'2025-03-19');
...
INSERT INTO `food_order_api_userorder` VALUES (7,1,'Pending','2025-03-19 22:23:14',1);
...
INSERT INTO `food_order_api_userprofile` VALUES (1,1,1,'24','Customer is the best one we have - never change! Stay Gold Pony boy!','Ready to Serve'),(2,1,2,NULL,NULL,NULL);
/*!40000 ALTER TABLE `food_order_api_userprofile` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `food_order_api_userprofile_delivery_schedule`
--

DROP TABLE IF EXISTS `food_order_api_userprofile_delivery_schedule`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `food_order_api_userprofile_delivery_schedule` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `userprofile_id` bigint NOT NULL,
  `deliveryschedule_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `food_order_api_userprofi_userprofile_id_deliverys_5a87a195_uniq` (`userprofile_id`,`deliveryschedule_id`),
  KEY `food_order_api_userp_deliveryschedule_id_2175a83a_fk_food_orde` (`deliveryschedule_id`),
  CONSTRAINT `food_order_api_userp_deliveryschedule_id_2175a83a_fk_food_orde` FOREIGN KEY (`deliveryschedule_id`) REFERENCES `food_order_api_deliveryschedule` (`id`),
  CONSTRAINT `food_order_api_userp_userprofile_id_8013e360_fk_food_orde` FOREIGN KEY (`userprofile_id`) REFERENCES `food_order_api_userprofile` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `food_order_api_userprofile_delivery_schedule`
--

LOCK TABLES `food_order_api_userprofile_delivery_schedule` WRITE;
/*!40000 ALTER TABLE `food_order_api_userprofile_delivery_schedule` DISABLE KEYS */;
INSERT INTO `food_order_api_userprofile_delivery_schedule` VALUES (1,1,1),(2,1,3),(3,2,1);
/*!40000 ALTER TABLE `food_order_api_userprofile_delivery_schedule` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `food_order_api_userprofile_lunch_programs`
--

DROP TABLE IF EXISTS `food_order_api_userprofile_lunch_programs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `food_order_api_userprofile_lunch_programs` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `userprofile_id` bigint NOT NULL,
  `lunchprogram_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `food_order_api_userprofi_userprofile_id_lunchprog_20431c35_uniq` (`userprofile_id`,`lunchprogram_id`),
  KEY `food_order_api_userp_lunchprogram_id_43ab76b8_fk_food_orde` (`lunchprogram_id`),
  CONSTRAINT `food_order_api_userp_lunchprogram_id_43ab76b8_fk_food_orde` FOREIGN KEY (`lunchprogram_id`) REFERENCES `food_order_api_lunchprogram` (`id`),
  CONSTRAINT `food_order_api_userp_userprofile_id_b4878978_fk_food_orde` FOREIGN KEY (`userprofile_id`) REFERENCES `food_order_api_userprofile` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `food_order_api_userprofile_lunch_programs`
--

LOCK TABLES `food_order_api_userprofile_lunch_programs` WRITE;
/*!40000 ALTER TABLE `food_order_api_userprofile_lunch_programs` DISABLE KEYS */;
INSERT INTO `food_order_api_userprofile_lunch_programs` VALUES (1,1,1),(2,1,2),(3,1,3),(4,1,4),(5,1,5),(6,2,3);
/*!40000 ALTER TABLE `food_order_api_userprofile_lunch_programs` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-03-20  3:30:11
